...
- [x] **1.4.1** Crear estructura del proyecto: ✅
  ...
  - [x] `env.example` ✅
  - [x] `src/index.ts` ✅
- [x] **1.4.2** Implementar Apollo Federation v2: ✅ 3 subgraphs funcionando
...
- [x] **1.5.5** Verificar que `docker-compose up` levanta todo sin errores ✅ 4 servicios + infraestructura arrancan correctamente
